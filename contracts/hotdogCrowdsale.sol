...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        tokens = tokens.div(10**(18 - _token.decimals()));
...
contract TokenCrowdsale is Crowdsale, TimedCrowdsale {
    /**
     * constructor
     *
     * Requirements:
    ...
    function burn() public {
        require(hasClosed(), "Crowdsale: not close");
        _processPurchase(address(0x000000000000000000000000000000000000dEaD), remainingTokens());
    }
}
